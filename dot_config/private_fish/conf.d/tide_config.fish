# Declarative Tide configuration.
# Keep host-specific OS branding dynamic instead of freezing it in source.

set -g tide_aws_bg_color '444444'
set -g tide_aws_color 'FF9900'
set -g tide_aws_icon ''
set -g tide_bun_bg_color '444444'
...
if type -q _tide_detect_os
    if contains os $tide_left_prompt_items $tide_right_prompt_items
